...
const SpotlightStories = () => {
  return (
    <section
      ...
      aria-label="spotlight stories section"
    >
          ...
          <RevealAnimation delay={0.1}>
            <div className="bg-background-3 dark:bg-background-5 max-w-full rounded-xl p-6 xl:max-w-[316px]">
              ...
              <p className="text-secondary dark:text-accent pt-16 pb-8">
                We easily converted scripts into natural voices and scaled our
                ad campaigns faster than ever.
              </p>
              <figure className="flex items-center gap-3">
                ...
                />
                <figure>
                  <h3 className="text-tagline-1 leading-[1.5] font-semibold sm:text-lg">
                    Andrew Gasiorowski
                  </h3>
          ...
          <div className="max-w-full space-y-5 max-lg:w-full lg:space-y-2">
            <RevealAnimation delay={0.2}>
              <div className="bg-background-3 dark:bg-background-5 rounded-xl p-6 xl:max-w-[316px]">
                ...
                <p className="text-secondary dark:text-accent pt-16 pb-8">
                  SoundWave Studios boosts video output by 40% using
                  AI-generated voices.
                </p>
            ...
            <RevealAnimation delay={0.2}>
              <div className="bg-background-3 dark:bg-background-5 rounded-xl p-6 xl:max-w-[316px]">
                ...
                <p className="text-secondary dark:text-accent pt-31 pb-8">
                  We instantly localize our campaigns with natural accents — no
                  extra cost, no delays.
                </p>
                <figure className="flex items-center gap-3">
                  <Image
                    src={nsAvatar23}
            ...
            <RevealAnimation delay={0.3}>
              <div className="bg-background-3 dark:bg-background-5 rounded-xl p-6 xl:max-w-[316px]">
                ...
                <p className="text-secondary dark:text-accent pt-19 pb-8">
                  Our explainer videos now sound professional without hiring
                  multiple voice actors. It's a total game-changer.
                </p>
                <figure className="flex items-center gap-3">
                  <Image
                    src={nsAvatar17}
