      ...
      <div className="text-center w-full px-4 md:px-0">
        <p className="text-white font-bold text-sm md:text-base">
          ...
          <span className="text-primary-500 font-bold block my-4 text-base md:text-lg">
            During this limited bonus period, valid until December 13, 2026, all staking amounts will receive the highest reward tier available in each plan — Whale 20%, Shark 18%, and Dolphin 16%.
          </span>
        </p>
      </div>
