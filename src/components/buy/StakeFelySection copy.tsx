                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <select className="w-full bg-[#13171E] border border-[#2a333e] rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-primary-500 appearance-none">
                        <option value="3">Silver (3 Months) - 2.5% APY</option>
                        <option value="6">Gold (6 Months) - 8% APY</option>
                        <option value="12">Platinum (12 Months) - 12.5% APY</option>
                      </select>
                    </div>
              ...
              <div className="bg-secondary dark:bg-background-8 rounded-[30px] p-6 border border-stroke-2 dark:border-stroke-6">
                <div className="space-y-6">
                  ...
                  <div className="flex gap-3">
                    ...
                    />
                    <select className="bg-[#13171E] border border-[#2a333e] rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-primary-500 appearance-none min-w-[120px]">
