        ...
        <div className="space-y-5 text-center">
          ...
          <div className="mx-auto max-w-[620px] space-y-3">
            <RevealAnimation delay={0.2}>
              <h2>The Heartbeat of Our Ecosystem</h2>
            </RevealAnimation>
            <RevealAnimation delay={0.3}>
              <p>
                A global network of empowered individuals who drive the vision of Felysyum forward. Join us in building the digital paradise.
              </p>
            </RevealAnimation>
          </div>
        </div>
