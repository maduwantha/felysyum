...
const BlogCardV2 = ({ blog, className }: BlogCardV2Props) => {
  return (
    ...
    <div>
      <article
        className={cn(
          'bg-background-2 dark:bg-background-7 mx-auto flex max-w-[627px] scale-100 flex-col gap-0 overflow-hidden rounded-[20px] transition-transform duration-500 hover:scale-[102%] hover:transition-transform hover:duration-500 sm:flex-row sm:gap-8 lg:mx-0 lg:max-w-full',
          className,
        )}>
        <figure className="h-[260px] w-full shrink-0 overflow-hidden rounded-[20px] sm:h-auto sm:w-[298.5px] xl:h-[260px]">
          <Image
            src={blog.thumbnail}
            alt="blog"
        ...
        <div className="space-y-4 p-8 sm:p-0 sm:py-8 sm:pr-8">
